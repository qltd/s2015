...
(function() {
  ...
  $(document).ready(function() {
    ...
    $('.affiliation-wrapper p').each(function(index, element) {
    ...
    $('.studio-projects .event-text').each(function(index, element) {
